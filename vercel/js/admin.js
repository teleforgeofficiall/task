...
function adminAddPromoted() {
  showModal('Admin › Add Promoted', `
    <div class="admin-form">
      ...
      <div class="form-group"><label>Image</label><input id="f_p_image" placeholder="Telegram post link or image URL" oninput="adminUpdatePromoPreview()"></div>
...
async function adminEditPromoted(id) {
  ...
  showModal('Admin › Edit Promoted #' + id, `
    <div class="admin-form">
      ...
      <div class="form-group"><label>Image</label><input id="f_p_image" value="${escHtml(item.image || '')}" placeholder="Telegram post link or image URL" oninput="adminUpdatePromoPreview()"></div>
...
async function adminSettings() {
  ...
  list.innerHTML += `
    <div class="setting-item" style="margin-top:12px;flex-direction:column;align-items:stretch;gap:8px">
      ...
      <input id="promoQrInput" placeholder="Telegram post link or image URL" style="width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;font-size:13px;box-sizing:border-box" value="${s.promo_qr_image || ''}">
